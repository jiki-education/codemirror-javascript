...
const keywords = "break case const continue default delete export extends false finally in instanceof let new repeat return static super switch this throw true typeof var yield".split(" ").map(kwCompletion)
